...
def _configure_local_remotes(workspace: Path, console: Console) -> None:
    gitea_outcome = ensure_remote(workspace, GITEA_REMOTE_NAME, GITEA_REPO_URL)
    github_outcome = ensure_remote(workspace, GITHUB_REMOTE_NAME, GITHUB_REPO_URL)
...
class ProvisionReposPhase:
    ...
    def run(self, ctx: PhaseContext) -> None:
        ...
        try:
            _configure_local_remotes(WORKSPACE_DIR, ctx.console)
